...
run_checks_for_lab() {
    ...
    case "$lab" in
        ...
        9)
            ...
            check_optional_path "labs/manifests/lab-09" "Lab 9 manifest overlay"
            ;;
        10)
        ...
        11)
            ...
            check_optional_path "labs/manifests/lab-11" "Lab 11 manifest overlay"
            ;;
        12)
            check_path "labs/12-kubernetes-fundamentals.md" "Lab 12 instructions" || missing=1
            ;;
    esac
