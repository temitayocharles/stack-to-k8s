...
declare module '$env/static/private' {
	...
	export const EXTERNAL_SSD_PATH: string;
	...
	export const VSCODE_USER_DATA_DIR: string;
	...
	export const PROMPT_CONTEXT_MODE: string;
